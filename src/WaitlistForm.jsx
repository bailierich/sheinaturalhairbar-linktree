...
export default function WaitlistForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ name: "", email: "", phone: "", termsAccepted: false });
      setErrors({});
    } catch (error) {
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  <input
                    ...
                    onChange={handleChange}
                    className="mt-1 h-4 w-4 text-[#3A4A32] focus:ring-[#3A4A32] border-gray-300 rounded"
                    required
                  />
                  <label className="block text-sm text-[#2D2D2D]/80 leading-relaxed">
                    I understand and agree to the following requirements: *
                  </label>
                </div>
                ...
                <div className="ml-7 space-y-2 text-sm text-[#2D2D2D]/70">
                  <p>
                    • This waitlist is only available for{" "}
                    <strong>new clients</strong>
                  </p>
                  <p>
                    • <strong>Chin length hair</strong> is required
                  </p>
                  <p>
                    • A <strong>Shei Natural Hair Spa appointment</strong> is
                    required to be booked for first-time clients
                  </p>
                </div>
              </div>
